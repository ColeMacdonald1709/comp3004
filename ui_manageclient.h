...
public:
    ...
    void setupUi(QDialog *ManageClient)
    {
        ...
        addclientbutton->setGeometry(QRect(110, 20, 150, 50));
        ...
        btnBack = new QPushButton(ManageClient);
        btnBack->setObjectName(QStringLiteral("btnBack"));
        btnBack->setGeometry(QRect(10, 30, 83, 31));
    ...
    void retranslateUi(QDialog *ManageClient)
    {
        ...
        btnBack->setText(QApplication::translate("ManageClient", "Back", Q_NULLPTR));
    } // retranslateUi
