...
public:
    ...
    void setupUi(QDialog *ManageAnimal)
    {
        ...
        addNewAnimalbtn = new QPushButton(centralWidget);
        addNewAnimalbtn->setObjectName(QStringLiteral("addNewAnimalbtn"));
        addNewAnimalbtn->setGeometry(QRect(120, 40, 161, 51));
        ...
        btnBack->setGeometry(QRect(20, 50, 83, 31));
        ...
        btnEditanimal = new QPushButton(centralWidget);
        btnEditanimal->setObjectName(QStringLiteral("btnEditanimal"));
        btnEditanimal->setEnabled(false);
        btnEditanimal->setGeometry(QRect(300, 40, 161, 51));
    ...
    void retranslateUi(QDialog *ManageAnimal)
    {
        ...
        addNewAnimalbtn->setText(QApplication::translate("ManageAnimal", "Add New Animal", Q_NULLPTR));
        ...
        btnBack->setText(QApplication::translate("ManageAnimal", "Back", Q_NULLPTR));
        ...
        btnEditanimal->setText(QApplication::translate("ManageAnimal", "Edit Animal", Q_NULLPTR));
