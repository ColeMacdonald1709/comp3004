...
struct qt_meta_stringdata_ACMDetailsUI_t {
    QByteArrayData data[5];
    char stringdata0[71];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ACMDetailsUI_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ACMDetailsUI_t qt_meta_stringdata_ACMDetailsUI = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ACMDetailsUI"
QT_MOC_LITERAL(1, 13, 21), // "on_backButton_clicked"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 28), // "on_ACMResultsTable_activated"
QT_MOC_LITERAL(4, 65, 5) // "index"

    },
    "ACMDetailsUI\0on_backButton_clicked\0\0"
    "on_ACMResultsTable_activated\0index"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_ACMDetailsUI[] = {
...
void ACMDetailsUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ACMDetailsUI *_t = static_cast<ACMDetailsUI *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject ACMDetailsUI::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ACMDetailsUI.data,
      qt_meta_data_ACMDetailsUI,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *ACMDetailsUI::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *ACMDetailsUI::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_ACMDetailsUI.stringdata0))
        return static_cast<void*>(this);
    return QDialog::qt_metacast(_clname);
}

int ACMDetailsUI::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QDialog::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
